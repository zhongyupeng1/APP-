import time
import os
from page_object.setup_teardown import Setup_Teardown

class Assert_Screenshot(Setup_Teardown):
    ...
    def assert_equal(self,driver,actual_result,expected_result):
        ...
        try:
            ...
            try:
                ...
                pass
            driver.get_screenshot_as_file('../images/%s/%s_%s.png' %(folder,run_methodName,nowtime))
            raise
